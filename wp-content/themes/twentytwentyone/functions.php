...
function custom_post_type()
{
	...
	$args = array(
		...
		'description'           => __('luxury product', 'text_domain'),
		'labels'                => $labels,
	...
	$args = array(
		...
		'description'           => __('luxury person', 'text_domain'),
		'labels'                => $labels,
		'supports'              => array('title', 'editor'),
		'taxonomies'            => array('tag'),
		'hierarchical'          => false,
	...
	$labels = array(
		'name'                  => _x('businesss', 'Post Type General Name', 'text_domain'),
		'singular_name'         => _x('business', 'Post Type Singular Name', 'text_domain'),
		'menu_name'             => __('businesss', 'text_domain'),
		'name_admin_bar'        => __('businesss', 'text_domain'),
		'archives'              => __('Item Archives', 'text_domain'),
		'attributes'            => __('Item Attributes', 'text_domain'),
		'parent_item_colon'     => __('Parent Item:', 'text_domain'),
		'all_items'             => __('All Items', 'text_domain'),
	...
	$args = array(
		...
		'description'           => __('luxury business', 'text_domain'),
		'labels'                => $labels,
		'supports'              => array('title', 'editor'),
		'taxonomies'            => array('tag'),
		'hierarchical'          => false,
	...
	$args = array(
		...
		'description'           => __('luxury organization', 'text_domain'),
		'labels'                => $labels,
		'supports'              => array('title', 'editor'),
		'taxonomies'            => array('tag'),
		'hierarchical'          => false,
	...
	$labels = array(
		'name'                  => _x('cells', 'Post Type General Name', 'text_domain'),
		'singular_name'         => _x('cell', 'Post Type Singular Name', 'text_domain'),
		'menu_name'             => __('cells', 'text_domain'),
		'name_admin_bar'        => __('cells', 'text_domain'),
		'archives'              => __('Item Archives', 'text_domain'),
		'attributes'            => __('Item Attributes', 'text_domain'),
		'parent_item_colon'     => __('Parent Item:', 'text_domain'),
		'all_items'             => __('All Items', 'text_domain'),
	...
	$args = array(
		...
		'description'           => __('luxury cell', 'text_domain'),
		'labels'                => $labels,
		'supports'              => array('title', 'editor'),
		'taxonomies'            => array('tag'),
		'hierarchical'          => false,
